                  ...
                  extra={
                    <div>
                      <Button
                        ...
                        size={"large"}
                        icon="edit"
                        onClick={event =>this.showModalm2 (event,element)}
                      />{" "}
                      <Button
                        type="danger"
                        size={"large"}
                        icon="delete"
                        onClick={event => this.handleDelete(event, element.id)}
                      />{" "}
                    </div>
                  }
                >
                  <Modal
                    ...
                    onOk={event => this.m2handleOk(event,element)}
                  ...
                  >
                    <Input
                      ...
                      allowClear
                      onChange={this.onChangeQuestion}
                      defaultValue={this.state.newquestion}
                    />
                    <Input
                      placeholder="Answer"
                      allowClear
