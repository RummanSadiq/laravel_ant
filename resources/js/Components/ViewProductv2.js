...
import { Col, Card, Table, Tag, Divider, Button, Input, InputNumber, Popconfirm, Form,Upload } from "antd";
        ...
        return (
            <div>
                <Col span={14} offset={6}>
                    ...
                    <Table columns={columns} dataSource={this.state.products}         components={components}
