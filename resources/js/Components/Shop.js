        ...
        <Col span={12} offset={6}>
          ...
          <Button
            ...
            Edit info
              ...
              <Row>
                  <Col span={12}>
              <span style={{ fontWeight: "bold" }}>Store Type:</span>
              <div style={{ fontWeight: "bold" }}>Contact</div>
              <div style={{ fontWeight: "bold" }}>OpeningTime</div>
              <div style={{ fontWeight: "bold" }}>ClosingTime</div>
              <div style={{ fontWeight: "bold" }}>Opens on Weekend</div>
              <div style={{ fontWeight: "bold" }}>Accepts Card</div>
              <div style={{ fontWeight: "bold" }}>Wifi</div>
              <div style={{ fontWeight: "bold" }}>Delivery</div>
              <div style={{ fontWeight: "bold" }}>Address</div>
            </Col>
            <Col span={12}>
              <div style={{ textAlign: "right", marginLeft: "60%" }}>
